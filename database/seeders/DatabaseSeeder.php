...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // Create or update a default user for testing
        ...
        // Create or update Graeme Sait as the instructor
        $graeme = Instructor::updateOrCreate(
            ...
            [
                ...
                'avatar' => '/how-to-thumbnails-languages/grow-courses.jpeg',
...
🎯 By the end, soil testing won\'t be a confusing lab report, but a powerful, practical tool that brings clarity and confidence to your farming decisions.',
            ...
            [
                'title' => '🎥 Chapter 1 - Watch the Video',
                'type' => 'video',
                'duration_minutes' => 20,
                'content' => '/videos/chapter-1-video.mp4',
                'order' => 2,
                'chapter' => 1
            ],
            [
                'title' => '📝 Chapter 1 -Detailed Summary',
                'type' => 'reading',
                'duration_minutes' => 5,
...
⏭️ Next: Let\'s start cracking the code of your soil test.',
            ...
            [
                'title' => '🎥 Chapter 2 - Watch the Video',
                'type' => 'video',
                'duration_minutes' => 20,
                'content' => '/videos/chapter-2-video.mp4',
                'order' => 5,
                'chapter' => 2
            ],
            [
                'title' => '📝 Chapter 2 - Detailed Summary',
                'type' => 'reading',
                'duration_minutes' => 15,
...
This is where knowledge meets action—let\'s get started.',
            ...
            [
                'title' => '🎥 Chapter 3 - Watch the Video',
                'type' => 'video',
                'duration_minutes' => 20,
                'content' => '/videos/chapter-3-video.mp4',
                'order' => 8,
                'chapter' => 3
            ],
            [
                'title' => '📝 Chapter 3 - Detailed Summary',
                'type' => 'reading',
                'duration_minutes' => 15,
...
This chapter isn\'t just academic—it\'s immediately practical. By the end, you\'ll be able to analyze your own soil report, spot the key ratios that need correction, and plan your inputs with confidence and cost-effectiveness.',
            ...
            [
                'title' => '🎥 Chapter 4 - Watch the Video',
                'type' => 'video',
                'duration_minutes' => 20,
                'content' => '/videos/chapter-4-video.mp4',
                'order' => 11,
                'chapter' => 4
            ],
            [
                'title' => '📝 Chapter 4 - Detailed Summary',
                'type' => 'reading',
                'duration_minutes' => 15,
...
Congratulations! You\'ve completed the four core chapters of the Soil Therapy Workshop course. You now understand:
...
🎯 Remember: soil testing isn\'t just data—it\'s the starting point for smarter, more sustainable farming.',
            ...
            // Final Quiz
            [
                'title' => 'Soil Therapy Workshop Final Quiz',
                'type' => 'quiz',
                'duration_minutes' => 30,
                'content' => 'Final assessment covering soil testing principles, mineral ratios, and interpretation techniques from all four chapters.',
                'order' => 13,
                'chapter' => 4,
                'questions' => [
                    [
        ...
        foreach ($lessons as $lessonData) {
            ...
            $lesson = $course->lessons()->updateOrCreate(
                ['title' => $lessonData['title'], 'course_id' => $course->id],
                $lessonData
            );
