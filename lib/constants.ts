...
export const MOCK_USERS: Array<{
  ...
  { id: '11111111-1111-1111-1111-111111111111', name: 'Super Admin', email: 'superadmin@ntsgrow.com', password: 'SuperAdmin123!', role: 'super-admin' },
  { id: '44444444-4444-4444-4444-444444444444', name: 'Franz Hentze', email: 'franz@nutri-tech.com.au', password: 'FranzSuperAdmin123!', role: 'super-admin' },
  { id: '55555555-5555-5555-5555-555555555555', name: 'Graeme Sait', email: 'graeme@nutri-tech.com.au', password: 'GraemeAdmin123!!', role: 'admin' },
  { id: '66666666-6666-6666-6666-666666666666', name: 'Andrew Cook', email: 'andrewc@nutri-tech.com.au', password: 'AndrewAdmin123!!', role: 'admin' },
  { id: '77777777-7777-7777-7777-777777777777', name: 'Marco Giorgio', email: 'marco@nutri-tech.com.au', password: 'MarcoAdmin123!!', role: 'admin' },
  { id: '88888888-8888-8888-8888-888888888888', name: 'Alan', email: 'alan@nutri-tech.com.au', password: 'AlanAgro123!!', role: 'agronomist' },
  { id: '99999999-9999-9999-9999-999999999999', name: 'Adriano', email: 'adriano@nutri-tech.com.au', password: 'AdrianoAgro123!!', role: 'agronomist' },
  { id: 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', name: 'Fred Ghorbani', email: 'fred@nutri-tech.com.au', password: 'FredAgro123!!', role: 'agronomist' },
  { id: 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', name: 'Karl Holland', email: 'karl@nutri-tech.com.au', password: 'KarlAgro123!!', role: 'agronomist' },
...
export const CATEGORY_OPTIONS = [
  { id: '1', name: 'Soil Chart Creation' },
  { id: '2', name: 'Soil Report Creation' },
  { id: '3', name: 'Leaf Chart Creation' },
  { id: '4', name: 'Leaf Report Creation' },
];
...
export const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: 'Leaf',
    roles: ['agronomist', 'admin', 'super-admin'],
    children: [
      {
        ...
        children: [
          {
            ...
            icon: 'Layers',
            children: [
              { id: 'create-soil-chart', label: 'Create Soil Chart', path: '/app/agronomist/soil/create-chart', icon: 'BarChart' },
              { id: 'create-soil-report', label: 'Create Soil Report', path: '/app/agronomist/soil/create-report', icon: 'FileText' },
              { id: 'view-soil-reports', label: 'View Saved Reports', path: '/app/agronomist/soil/reports', icon: 'FolderOpen' },
            ]
          },
          {
            id: 'plant',
            ...
            icon: 'Flower',
            children: [
              { id: 'create-leaf-chart', label: 'Create Leaf Chart', path: '/app/agronomist/plant/create-chart', icon: 'BarChart' },
              { id: 'create-leaf-report', label: 'Create Leaf Report', path: '/app/agronomist/plant/create-report', icon: 'FileText' },
              { id: 'view-leaf-reports', label: 'View Saved Reports', path: '/app/agronomist/plant/reports', icon: 'FolderOpen' },
            ]
          },
          {
            id: 'crop-nutrition',
            label: 'Crop Nutrition Thresholds',
            path: '/app/agronomist/crop-nutrition',
            icon: 'Scale'
          },
        ]
      },
      {
        ...
        icon: 'ClipboardList',
        children: [
          { id: 'enter-analysis', label: 'Register New Analysis', path: '/app/agronomist/analysis/enter', icon: 'Plus' },
          { id: 'analysis-analytics', label: 'Analysis Analytics', path: '/app/agronomist/analysis/analytics', icon: 'BarChart3' },
          { id: 'analysis-pricing', label: 'Pricing Management', path: '/app/agronomist/analysis/pricing', icon: 'DollarSign' },
        ]
      },
      {
        id: 'smart-tools',
        ...
        children: [
          {
            ...
            icon: 'Droplets',
            children: [
              { id: 'irrigation-calculation', label: 'Irrigation Calculation', path: '/app/agronomist/smart-tools/irrigation/calculation', icon: 'Calculator' },
            ]
          },
          {
            id: 'crop-nutrition',
            ...
            icon: 'Leaf',
            children: [
              { id: 'nts-product-recommendator', label: 'NTS Product Recommendator', path: '/app/agronomist/smart-tools/crop-nutrition/recommendator', icon: 'Package' },
            ]
          },
          {
            id: 'crop-protection',
            ...
            icon: 'Shield',
            children: [
              { id: 'growing-degree-days', label: 'Growing Degree Days', path: '/app/agronomist/smart-tools/crop-protection/gdd', icon: 'Thermometer' },
            ]
          },
        ]
      },
      {
        ...
        icon: 'Satellite',
        children: [
          { id: 'satellite-crop-health', label: 'Crop Health', path: '/app/agronomist/satellite/crop-health', icon: 'Activity' },
          { id: 'weather', label: 'Weather', path: '/app/agronomist/satellite/weather', icon: 'Cloud' },
        ]
      },
      { id: 'chatbots', label: 'G-Man Chat', path: '/app/agronomist/chat', icon: 'MessageCircle' },
      { id: 'agronomist-documents', label: 'Documents', path: '/app/agronomist/documents', icon: 'Folder' },
      {
        id: 'client-management',
        label: 'Client Management',
        icon: 'Users',
        children: [
          { id: 'client-database', label: 'Client Database', path: '/app/agronomist/clients', icon: 'Database' },
        ]
      },
      {
        id: 'field-visits',
        ...
        icon: 'MapPin',
        children: [
          { id: 'field-visits-management', label: 'Field Visits Management', path: '/app/agronomist/field-visits', icon: 'ClipboardCheck' },
        ]
      },
      {
        id: 'field-trials',
        ...
        icon: 'Target',
        children: [
          { id: 'trial-project-management', label: 'Trial Project Management', path: '/app/agronomist/field-trials', icon: 'ClipboardList' },
          { id: 'treatment-variable-management', label: 'Treatment & Variable Management', path: '/app/agronomist/field-trials/treatments', icon: 'Package' },
          {
            id: 'data-management',
            label: 'Data Management',
            icon: 'Database',
            children: [
              { id: 'data-collection-management', label: 'Data Collection Management', path: '/app/agronomist/field-trials/data-collection', icon: 'Database' },
              { id: 'data-summary', label: 'Data Summary', path: '/app/agronomist/field-trials/data-summary', icon: 'BarChart' }
            ]
          },
          {
            ...
            icon: 'BarChart3',
            children: [
              { id: 'analysis', label: 'Analysis', path: '/app/agronomist/field-trials/analytics/analysis', icon: 'BarChart' },
              { id: 'statistics', label: 'Statistics', path: '/app/agronomist/field-trials/analytics/statistics', icon: 'TrendingUp' }
            ]
          },
          { id: 'trial-reports', label: 'Reporting & Sharing', path: '/app/agronomist/field-trials/reports', icon: 'FileText' },
        ]
      },
      { id: 'product-batch-production', label: 'Product Batch Production', path: '/app/agronomist/product-batch-production', icon: 'Factory' },
      {
        id: 'nutrition-farms',
        label: 'Nutrition Farms',
        icon: 'Truck',
        path: '/app/agronomist/nutrition-farms',
      },
      {
        id: 'distributor-network',
        label: 'Distributor Network',
        icon: 'Network',
        path: '/app/agronomist/distributor-network',
      },
      {
        id: 'crops-ai',
        label: 'Crops AI',
        ...
        children: [
          {
            ...
            label: 'Plant ID',
            icon: 'Flower',
            path: '/app/agronomist/plant-id',
          },
          {
            id: 'insect-id',
            label: 'Insect ID',
            icon: 'Bug',
            path: '/app/agronomist/insect-id',
          },
          {
            id: 'mushroom-id',
            label: 'Mushroom ID',
            icon: 'HelpCircle',
            path: '/app/agronomist/mushroom-id',
          },
          {
            id: 'crop-health-id',
            label: 'Crop Health ID',
            icon: 'HeartPulse',
            path: '/app/agronomist/crop-health',
          },
        ]
      },
    ]
  },
  {
    ...
    icon: 'Book',
    children: [
      { id: 'grow-library', label: 'G.R.O.W Library', path: '/app/education/library', icon: 'Library' },
      { id: 'online-learning', label: 'Online Learning', icon: 'GraduationCap', children: [
        { id: 'courses', label: 'Courses', path: '/app/education/online-learning/courses', icon: 'ListChecks' },
        { id: 'podcast', label: 'Podcast', path: '/app/education/online-learning/podcast', icon: 'Mic' },
        { id: 'videos', label: 'Videos', path: '/app/education/online-learning/videos', icon: 'Video', comingSoon: true },
      ] },
      { id: 'grow-health-index', label: 'G.R.O.W Health Index', path: '/app/education/health-index', icon: 'HeartPulse', comingSoon: true },
      { id: 'events', label: 'Events', path: '/app/events', icon: 'Calendar' },
      {
        ...
        icon: 'Gamepad2',
        children: [
          { id: 'trivia-challenge', label: 'Trivia Challenge', path: '/app/education/arcade/trivia', icon: 'HelpCircle', comingSoon: true },
        ]
      },
      { id: 'new-education-page', label: 'Science Simulations', path: '/app/education/new-page', icon: 'Atom' },
    ]
  },
  {
    id: 'grow-admin',
    ...
    children: [
      {
        ...
        icon: 'BarChart3',
        children: [
          { id: 'web-traffic', label: 'Web Traffic Analytics', path: '/app/admin/web-traffic', icon: 'LineChart' },
          { id: 'financial-analytics', label: 'Financial Analytics', path: '/app/admin/financial', icon: 'DollarSign' },
        ]
      },
      {
        id: 'grow-development',
        ...
        icon: 'Code',
        children: [
          { id: 'task-calendar', label: 'Task Calendar', path: '/app/admin/task-calendar', icon: 'Calendar' },
          { id: 'monthly-strategies', label: 'Monthly Strategies', path: '/app/admin/monthly-strategies', icon: 'Target' },
        ]
      },
      {
        ...
        icon: 'Settings',
        path: '/app/education/online-learning/course-management',
      },
      {
        id: 'event-manager',
        label: 'Event Manager',
        icon: 'Calendar',
        children: [
          { id: 'events-table', label: 'All Events', path: '/app/super-admin/events-table', icon: 'ListChecks' },
          { id: 'add-event', label: 'Add Event', path: '/app/super-admin/add-event', icon: 'PlusCircle' }
        ]
      }
    ]
  },
  {
    ...
    children: [
      { id: 'task-management', label: 'Task Management', path: '/app/super-admin/task-management', icon: 'ClipboardEdit' },
      { id: 'strategy-management', label: 'Strategy Management', path: '/app/super-admin/strategy-management', icon: 'Target' },
      { id: 'cost-management', label: 'Cost Management', path: '/app/super-admin/cost-management', icon: 'DollarSign' },
    ]
  },
];
